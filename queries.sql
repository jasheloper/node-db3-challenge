...
-- Display the order Id and shipper CompanyName 
--for all orders placed before August 9 2012. Shows 429 records.
SELECT o.Id,
       s.CompanyName,
       o.ShippedDate
  FROM [order] AS o
...
-- Display the OrderID, Customer's Company Name and the 
--employee's LastName for every order. All columns should 
--be labeled clearly. Displays 16,789 records.
